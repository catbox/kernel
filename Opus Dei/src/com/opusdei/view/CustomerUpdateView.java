 ...
 * Description: UI for updating data
 *
 */
package com.opusdei.view;
...
public class CustomerUpdateView {
	...
	/**
	 * @uml.property  name="customerUpdatePanel"
	 */
	private JPanel customerUpdatePanel;
	...
	/**
	 * @uml.property  name="customerUpdateButton"
	 */
	private JToggleButton customerUpdateButton;
	/**
	...
	public CustomerUpdateView(Customer customer) {
		...
		customerIdTextField.setText(this.customer.getCustomerId());
		...
		middleNameTextField.setText(this.customer.getMiddleName());
		...
		streetTextField.setText(this.customer.getStreet());
		...
		cityTextField.setText(this.customer.getCity());
		...
		primaryPhoneNumberTextField.setText(this.customer.getPrimaryPhoneNumber());
		...
		secondaryPhoneNumberTextField.setText(this.customer.getSecondaryPhoneNumber());
		...
		faxNumberTextField.setText(this.customer.getFaxNumber());
		...
		websiteTextField.setText(this.customer.getWebsite());
		...
		// Panel
		customerUpdatePanel = new JPanel(new MigLayout("", "[]", "[][][]"));
		
		ImageIcon icon = Utilities.createImageIcon("editProperties.gif", "Edit");
	    customerUpdateButton = new JToggleButton(icon);
	    customerUpdateButton.setMaximumSize(new Dimension(25, 25));
	    customerUpdateButton.setFocusable(false);
	    customerUpdateButton.setBorder(BorderFactory.createEmptyBorder());
	    customerUpdateButton.setToolTipText("Click to switch to update mode");
	    customerUpdatePanel.add(customerUpdateButton, "gapleft 10, wrap");
	    
		customerUpdatePanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory
		...
		customerUpdatePanel.add(customerPersonalInfoPanel, "wrap");
		...
		customerUpdatePanel.add(customerAddressPanel, "wrap");
		...
		// Add Customer Address Panel to the main panel
		customerUpdatePanel.add(customerContactPanel, "wrap");
		...
		customerUpdatePanel.add(customerButtonPanel);
		
		// Add the main panel into a scroll pane fore scrolling purposes
		customerUpdateScrollPane = new JScrollPane(customerUpdatePanel,ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
	...
	public void setMandatoryFields(boolean edit) {	
		if(edit){
			...
			ValidationComponentUtils.updateComponentTreeMandatoryBackground(customerUpdatePanel);
		}
		else {
	...
	public void buttonHandler(ActionListener actionListener) {
		customerUpdateButton.addActionListener(actionListener);
	...
	public void mouseHandler(MouseListener mouseListener) {
		customerUpdateButton.addMouseListener(mouseListener);	
	}
	...
	/**
	 * @return   the customerUpdatePanel
	 * @uml.property  name="customerUpdatePanel"
	 */
	public JPanel getCustomerUpdatePanel() {
		return customerUpdatePanel;
	}
	
	/**
	 * @param customerUpdatePanel   the customerUpdatePanel to set
	 * @uml.property  name="customerUpdatePanel"
	 */
	public void setCustomerUpdatePanel(JPanel customerUpdatePanel) {
		this.customerUpdatePanel = customerUpdatePanel;
	}
	...
	/**
	 * @return   the customerUpdateButton
	 * @uml.property  name="customerUpdateButton"
	 */
	...
	/**
	 * @param customerUpdateButton   the customerUpdateButton to set
	 * @uml.property  name="customerUpdateButton"
	 */
	public void setCustomerUpdateButton(JToggleButton customerUpdateButton) {
		this.customerUpdateButton = customerUpdateButton;
	}
